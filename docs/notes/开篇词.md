>小傅哥 | [https://bugstack.cn](https://bugstack.cn) <br/>沉淀、分享、成长，专注于原创专题案例，以最易学习编程的方式分享知识，让自己和他人都能有所收获。目前已完成的专题有；Netty4.x实战专题案例、用Java实现JVM、基于JavaAgent的全链路监控、手写RPC框架、架构设计专题案例、源码分析、算法学习等。

## 一、前言

万万没想到！`Github` 竟然受到攻击了！还能让我使用了 `GitPage` 的博客瘫痪了！

![](https://user-gold-cdn.xitu.io/2020/3/28/17120b1af35d21c1?w=797&h=464&f=png&s=134295)
...
![](https://user-gold-cdn.xitu.io/2020/3/28/17120c306fa97b02?w=512&h=397&f=png&s=95110)

### 2. 设置路径和选项

![](https://user-gold-cdn.xitu.io/2020/3/28/17120c3efbda4aad?w=513&h=396&f=png&s=75311)
...
![](https://user-gold-cdn.xitu.io/2020/3/28/17120c3efbfabb83?w=511&h=395&f=png&s=62905)

>初步安装成功，点击 `Finsh`

![](https://user-gold-cdn.xitu.io/2020/3/28/17120c3efc0089ed?w=513&h=397&f=png&s=117212)
...
![](https://user-gold-cdn.xitu.io/2020/3/28/17120b1a08a682ad?w=677&h=442&f=png&s=133374)

>命令 1

![](https://user-gold-cdn.xitu.io/2020/3/28/17120b1b419dbf28?w=677&h=442&f=png&s=71048)

>命令 2

![](https://user-gold-cdn.xitu.io/2020/3/28/17120b1b76e4bf2d?w=677&h=442&f=png&s=52191)

>命令 3

![](https://user-gold-cdn.xitu.io/2020/3/28/17120b1b83af27c0?w=678&h=442&f=png&s=151299)
...
![](https://user-gold-cdn.xitu.io/2020/3/28/17120b1b9fa55861?w=1305&h=681&f=png&s=174035)
...
![](https://user-gold-cdn.xitu.io/2020/3/28/17120b1ba60033d7?w=456&h=367&f=png&s=77382)
...
![](https://user-gold-cdn.xitu.io/2020/3/28/17120b1bd3a9571c?w=1295&h=928&f=png&s=224049)
...
![](https://user-gold-cdn.xitu.io/2020/3/28/17120b1bd8070457?w=1258&h=489&f=png&s=167330)
